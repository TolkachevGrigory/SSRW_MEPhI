 ...
 int tmvafirst( TString myMethodList = "" )
 {
	...
	std::cout << "--- TMVAClassification       : Using training background file : " << bg_input->GetName() << std::endl;
	std::cout << "--- TMVAClassification       : Using training signal     file : " << sig_input->GetName() << std::endl;


	// Register the training and test trees
	TTree *signalTree = (TTree*)sig_input->Get("NOMINAL");
	TTree *background = (TTree*) bg_input->Get("NOMINAL");
